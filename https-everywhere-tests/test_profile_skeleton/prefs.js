...
user_pref("extensions.encryptedweb._observatory.enabled", true);
// Don't show any popups that might get in the way of testing.
user_pref("extensions.encryptedweb._observatory.popup_shown", true);
user_pref("extensions.encryptedweb.toolbar_hint_shown", true);
// Show all logs.
user_pref("extensions.encryptedweb.LogLevel", 0);
user_pref("extensions.encryptedweb.log_to_stdout", true);
// Allow running of Mixed Content Blocking tests.
user_pref("extensions.encryptedweb.show_ruleset_tests", true);
